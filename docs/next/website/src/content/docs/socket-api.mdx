...
| Plugins | `plugin.link`, `plugin.list`, `plugin.unlink`, `plugin.enable`, `plugin.disable`, `plugin.action.list`, `plugin.action.invoke`, `plugin.log.list`, `plugin.storage.get`, `plugin.storage.set`, `plugin.storage.delete`, `plugin.storage.list`, `plugin.pane.open`, `plugin.pane.focus`, `plugin.pane.close` |
...
```json
{"id":"req_plugin_storage_set","method":"plugin.storage.set","params":{"plugin_id":"example.board","key":"kanban/cards","value":[{"uuid":"card-1","title":"Card"}]}}
```

Read, list, or delete storage values:

```json
{"id":"req_plugin_storage_get","method":"plugin.storage.get","params":{"plugin_id":"example.board","key":"kanban/cards"}}
{"id":"req_plugin_storage_list","method":"plugin.storage.list","params":{"plugin_id":"example.board","prefix":"kanban/"}}
{"id":"req_plugin_storage_delete","method":"plugin.storage.delete","params":{"plugin_id":"example.board","key":"kanban/cards"}}
```
