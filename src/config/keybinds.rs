...
impl Config {
    pub(super) fn validated_keybinds(&self) -> (Option<String>, KeyCombo, Vec<String>, Keybinds) {
        ...
        let mut keybinds = Keybinds {
            ...
            toggle_kanban: empty_action!(),
            speech_to_text: empty_action!(),
            audio_summary: empty_action!(),
        ...
        for source in [BindingSource::User, BindingSource::Default] {
            ...
            apply_action!(keybinds.toggle_kanban, toggle_kanban, source);
            apply_action!(keybinds.speech_to_text, speech_to_text, source);
            apply_action!(keybinds.audio_summary, audio_summary, source);
